...
class FormBuilderPage {
  constructor(page) {
    ...
    // Navigation
    this.automationMenu = page.locator('text=Automation').first();
  ...
  /**
   * Drags a Text Box element from the palette onto the canvas.
   */
  async addTextBox() {
  ...
  /**
   * Sets properties for the currently-selected textbox element.
   */
